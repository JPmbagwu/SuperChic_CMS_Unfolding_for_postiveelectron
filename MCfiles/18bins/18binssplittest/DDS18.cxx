...
void ManuelPositronResponseMatrix() { // MODIFIED FOR e+: Changed function name to reflect positron analysis
    ...
    string outfile_pseudo = "DDS18_pseudodata_25_positron.root"; // MODIFIED FOR e+: Added positron to filename
    string outfile_response = "DDS18_response_75_positron.root"; // MODIFIED FOR e+: Added positron to filename
    ...
    cSplitMCValidation->SaveAs("DDS18SplitMCValidation_split_25_75_positron.pdf"); // MODIFIED FOR e+: Updated filename
    ...
    cRefoldValidation->SaveAs("DDS18RefoldValidation_Superchic_positron.pdf"); // MODIFIED FOR e+: Updated filename
    ...
    cUnfoldedPseudodataPurityCorrectedOverAcceptanceVsGen25->SaveAs("DDS18UnfoldedPseudodataPurityCorrectedOverAcceptanceVsGen25_Superchic_positron.pdf"); // MODIFIED FOR e+: Updated filename
    ...
    cUnfoldedRecoTrueOverAcceptanceVsGenTrue25->SaveAs("DDS18UnfoldedRecoTrueOverAcceptanceVsGenTrue25_Superchic_positron.pdf"); // MODIFIED FOR e+: Updated filename
